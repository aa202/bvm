...
//      Serial.println("5");
  ...
  if ((ms_curr - new_breath_t > 0) && (ms_curr - rev_flow_t > 0) && (med_breath == true || large_breath == true)) { 

//    Serial.println("6");
    if (ms_curr - new_breath_t < 6000){ // waits six seconds until it resets green lights
